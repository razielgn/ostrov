...
fn parse_value<'input>(input: &'input str, state: &mut ParseState, pos: usize)
 -> RuleResult<AST> {
    {
            ...
            let seq_res =
                {
                    ...
                    match choice_res {
                        ...
                        Failed => {
                            ...
                            {
                                let seq_res =
                                    parse_peculiar_identifier(input, state,
                                                              pos);
                                match seq_res {
                                    Matched(pos, _) => {
                                        {
...
fn parse_initial<'input>(input: &'input str, state: &mut ParseState,
...
fn parse_constituent<'input>(input: &'input str, state: &mut ParseState,
                             pos: usize) -> RuleResult<&'input str> {
...
fn parse_special_initial<'input>(input: &'input str, state: &mut ParseState,
                                 pos: usize) -> RuleResult<&'input str> {
    {
        let start_pos = pos;
        {
...
fn parse_subsequent<'input>(input: &'input str, state: &mut ParseState,
                            pos: usize) -> RuleResult<&'input str> {
    {
...
fn parse_peculiar_identifier<'input>(input: &'input str,
...
fn parse_special_subsequent<'input>(input: &'input str,
                                    state: &mut ParseState, pos: usize)
 -> RuleResult<&'input str> {
    {
        let start_pos = pos;
...
fn parse_list<'input>(input: &'input str, state: &mut ParseState, pos: usize)
 -> RuleResult<AST> {
    {
        let choice_res =
            {
...
fn parse_boolean_char<'input>(input: &'input str, state: &mut ParseState,
                              pos: usize) -> RuleResult<&'input str> {
    {
        let start_pos = pos;
        {
            let seq_res =
                ...
                } else { state.mark_failure(pos, "[tfTF]") };
            match seq_res {
                Matched(pos, _) => {
                    {
                        let match_str = &input[start_pos..pos];
...
fn parse_digits<'input>(input: &'input str, state: &mut ParseState,
                        pos: usize) -> RuleResult<&'input str> {
    {
        let start_pos = pos;
        {
...
fn parse_sign<'input>(input: &'input str, state: &mut ParseState, pos: usize)
...
fn parse_quoted<'input>(input: &'input str, state: &mut ParseState,
                        pos: usize) -> RuleResult<AST> {
    {
        let start_pos = pos;
        {
